...
self.addEventListener('fetch', e => {
  ...
  if (url.includes('journal_data.json.gz') || url.includes('cn_core_data.json') || url.includes('cssci_data.json') || url.includes('cscd_data.json') || url.includes('api.crossref.org')) {
    e.respondWith(
